...
Now we can express declaratively that boros are formed from a collection of neighborhoods
...
function to declaratively inspect what components are shared across boroughs.
...
to get a visual representation of these shared faces as follows:
...
We do still have gaps of empty space between neighborhoods caused by intensive simplification.
